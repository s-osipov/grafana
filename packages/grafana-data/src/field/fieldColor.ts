  ...
  return [
    {
      ...
      name: 'Один цвет',
      description: 'Установить определенный цвет',
      getCalculator: getFixedColor,
    },
    {
      id: FieldColorModeId.Shades,
      name: 'Оттенки цвета',
      description: 'Выбрать оттенки определенного цвета',
    ...
    },
    {
      ...
      name: 'Из диапазонов',
      isByValue: true,
      description: 'Получение цветов из диапазонов',
    ...
    new FieldColorSchemeMode({
      ...
      name: 'Классическая палитра (по названию серии)',
      isContinuous: false,
      isByValue: false,
      useSeriesName: true,
      getColors: (theme: GrafanaTheme2) => {
